...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "postsArchive", function() { return postsArchive; });
/* harmony import */ var _global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _getPostTypes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
/*
Luke Harby
slackwise LTD
https://slackwise.org.uk
...
var postsArchive = function postsArchive() {
  var apiKey = "Quz8UcJXgTqT3zUdmoyoyn4nOAEHBZ5kVD1NwuKGDkQ0K3nogf";
  ...
  var retrieveMore = function retrieveMore(offset) {
    ...
    var url = new URL("https://".concat(process.env.NEXT_PUBLIC_API_BASE_URL).concat(process.env.NEXT_PUBLIC_API_BLOG, "/posts?offset=").concat(offset));
    ...
    fetch(url, options).then(function (response) {
      ...
      if (response) {
        ...
        posts.forEach(function (item) {
          ...
          var type = Object(_getPostTypes__WEBPACK_IMPORTED_MODULE_2__["getPostTypes"])(doc);
