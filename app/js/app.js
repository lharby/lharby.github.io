...
var REMOTE_SERVER = process.env.NEXT_PUBLIC_REMOTE_SERVER;
...
var appendForm = function appendForm() {
  ...
  form.setAttribute('action', "".concat(_global__WEBPACK_IMPORTED_MODULE_0__["REMOTE_SERVER"], "sites/").concat(_global__WEBPACK_IMPORTED_MODULE_0__["REMOTE_PATH"], "/includes/mailer.php"));
};
